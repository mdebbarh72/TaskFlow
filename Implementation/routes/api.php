...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        //  Projects
            ...
            Route::get   ('projects/{project}/members',        [\App\Modules\Projects\Controllers\ProjectController::class,          'members']);
            ...
            Route::delete('projects/{project}/leave',          [\App\Modules\Projects\Controllers\MembershipController::class,       'leave']);
        ...
        // Cards
            ...
            Route::post  ('cards/{card}/subtasks',                [\App\Modules\Board\Controllers\CardController::class, 'addSubtask']);
            Route::patch ('cards/{card}/subtasks/{subtask}/toggle', [\App\Modules\Board\Controllers\CardController::class, 'toggleSubtask']);
            Route::delete('cards/{card}/subtasks/{subtask}',      [\App\Modules\Board\Controllers\CardController::class, 'deleteSubtask']);
